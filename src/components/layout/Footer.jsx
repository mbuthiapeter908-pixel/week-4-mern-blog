        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
              ...
              Share your stories, insights, and connect with readers worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/categories/technology" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition-colors">
                  Technology
                </Link>
              </li>
              <li>
                <Link to="/categories/programming" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition-colors">
                  Programming
                </Link>
              </li>
              <li>
                <Link to="/categories/design" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition-colors">
                  Design
                </Link>
              </li>
              <li>
                <Link to="/categories/lifestyle" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition-colors">
                  Lifestyle
                </Link>
              </li>
            </ul>
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-colors"
                  required
                />
              </div>
              <button
